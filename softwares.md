...
* [DiffOpt.jl](https://github.com/jump-dev/DiffOpt.jl): Implicit differentiation of the solution of JuMP parametric optimization programs with respect to the parameters.
* [ArrayDiff.jl](https://github.com/blegat/ArrayDiff.jl): Tensor AD for JuMP.
* [GenOpt.jl](https://github.com/blegat/GenOpt.jl): Pack groups of similar constraints of sum of similar terms into lightweight generators. This representation can then be used by [ExaModels](https://github.com/exanauts/ExaModels.jl) to accelerate the Automatic Differentiation on GPU.
* [LowRankOpt.jl](https://github.com/blegat/LowRankOpt.jl): Low-rank constraints and Burer-Monteiro formulation.
* [ComplementOpt.jl](https://github.com/blegat/ComplementOpt.jl): Reformulation of complementarity constraints.
~~~
